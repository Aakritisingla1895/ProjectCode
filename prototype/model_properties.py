...
from models.build_effnet import build_name_model
from models.build_effnet_age import build_age_model
from models.build_effnet_texture import build_texture_model
from models.build_effnet_shape import build_shape_model
...
class ModelBuilder():
    ...
    def __init__(self, image, weight_name_path, weight_AMT_path, weight_shape_path, weight_texture_path, json_path):
        self.image = image
    ...
    def get_character_details(self):
        ...
        self.write_to_json(self.json_path)
    ...
    def process_image(self, image):
        ...
        return image_transforms["test"](img)
    ...
    def write_to_json(self, json_path):
